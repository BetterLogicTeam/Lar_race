...
import lrrace from '../../Assest/images/lrrace.png'
    ...
    return (
        <div>
            ...
            <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark" className='Header'>
                <Container>
                    <Navbar.Brand href="#home" className='border2' >
                        <img src={lrrace} alt="" width="100%" />
                    </Navbar.Brand>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="ms-auto Header_nav_text">
                            ...
                            <Nav.Link href="#" className='navbtn'>
                                <Link to="Items/Mint" className='nav_link_header'>
